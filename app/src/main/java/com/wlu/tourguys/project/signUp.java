...
public class signUp extends AppCompatActivity {
    ...
    private EditText signupPasswordEditText, signupPasswordConfirmEditText, signupEmailEditText, signupNameEditText;
...
//        notARobotCheckbox.setOnCheckedChangeListener((buttonView, isChecked) -> {
//            if (isChecked) {
//                startActivity(new Intent(signUp.this, verifyHuman.class));
